  ...
  return (
    <main className="">
      ...
      <p className="text-center font-light p-2">
        This was made for informational and educational purposes only. We do not
        own or affiliate with FileDrop or/ad any of its subsidiaries in any
        form. Copyright Disclaimer under section 107 of the Copyright Act 1976,
        allowance is made for &quot;fair use&quot; of this web app.
      </p>
    </main>
  );
}
